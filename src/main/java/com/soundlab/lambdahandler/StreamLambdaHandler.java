...
import com.soundlab.template.TemplateApplication;
import com.soundlab.template.exceptions.StreamLambdaHandlerException;
    ...
    static {
        ...
        try {
            handler = new SpringBootProxyHandlerBuilder()
                .defaultProxy()
                .asyncInit(startTime)
                .springBootApplication(TemplateApplication.class)
                .buildAndInitialize();
